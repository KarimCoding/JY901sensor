...
static std::vector <int> twoParamCommands = {5,6,7,8,9,10,11,12,13,18,19,20,21,22,23,24,25
                                            };




static vector <string> options = {"2400", "4800", "9600", "19200", "38400", "57600", "115200", "230400", "460800" , "921600"};
static vector <unsigned char> unsignedChars= {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09};


static vector <unsigned char> hexOptions =
{
